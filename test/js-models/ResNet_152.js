...
channels[0] = 16, channels[1] = 64, channels[2] = 128, channels[3] = 256, channels[4] = 512;
...
var bottleNeckBlockChannel = new Array(3);

for(var i = 0 ; i < 4; ++i)
{
    bottleNeckBlockChannel[0] = channels[i] * 4;
    bottleNeckBlockChannel[1] = channels[i + 1];
    bottleNeckBlockChannel[2] = channels[i + 1] * 4;
    x = BottleNeckBlock(x, bottleNeckBlockChannel, strides[i], resNet152[i]);
}
...
print("resNet_152 ：" + (sum_time / 4 / 1000) + " ms");